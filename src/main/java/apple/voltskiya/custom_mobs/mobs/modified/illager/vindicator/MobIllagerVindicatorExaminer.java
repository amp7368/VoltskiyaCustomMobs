...
public class MobIllagerVindicatorExaminer extends EntityVindicator {
    ...
    private static EntityTypes<apple.voltskiya.custom_mobs.mobs.modified.illager.vindicator.MobIllagerVindicatorExaminer> entityTypes;
    ...
    public static void initialize() {
        EntityTypes.Builder<apple.voltskiya.custom_mobs.mobs.modified.illager.vindicator.MobIllagerVindicatorExaminer> entitytypesBuilder = EntityTypes.Builder.a(apple.voltskiya.custom_mobs.mobs.modified.illager.vindicator.MobIllagerVindicatorExaminer::new, EnumCreatureType.MONSTER);
        ...
        final Type<?> oldType = types.get("minecraft:vindicator");
    ...
    private static void spawn(Location location, @Nullable NBTTagCompound oldNbt) {
        ...
        final apple.voltskiya.custom_mobs.mobs.modified.illager.vindicator.MobIllagerVindicatorExaminer examiner = new apple.voltskiya.custom_mobs.mobs.modified.illager.vindicator.MobIllagerVindicatorExaminer(entityTypes, world.getHandle());
