...
public class LeapDo implements Runnable {
    ...
    public LeapDo(EntityInsentient entity, Supplier<Location> getGoalLocation, Location providedLocation, LeapPreConfig preConfig, LeapPostConfig postConfig) throws IllegalArgumentException {
        this.entity = entity;
