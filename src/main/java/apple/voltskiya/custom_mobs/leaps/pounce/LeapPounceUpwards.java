...
public class LeapPounceUpwards extends ConfigManager {
    private static LeapPounceUpwards instance;

    public LeapPounceUpwards() {
        instance = this;
    ...
    private void eatEntity(EntityInsentient entity) {
        LeapPounce.eatEntity(entity, LeapType.POUNCE_LEAP_UP);
        instance.addMobs(entity.getUniqueID());
    }

    public static void eatSpawnEvent(CreatureSpawnEvent event) {
        LeapPounce.eatSpawnEvent(event, LeapType.POUNCE_LEAP_UP);
