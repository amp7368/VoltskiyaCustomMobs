...
public class PathfinderGoalLeapReposition extends PathfinderGoalLeap {
    private static final int OUTER_RADIUS = 10;
    private static final int INNER_RADIUS = 1;
    private static final int BELOW_PLAYER_Y = 7;

    public PathfinderGoalLeapReposition(EntityInsentient me, LeapPreConfig config, LeapPostConfig postConfig) {
