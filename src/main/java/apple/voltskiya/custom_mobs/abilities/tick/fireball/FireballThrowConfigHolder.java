...
import apple.voltskiya.custom_mobs.abilities.tick.fireball.config.FireballThrowConfigBasic;
import apple.voltskiya.custom_mobs.abilities.tick.fireball.config.FireballThrowConfigBasic3;
import apple.voltskiya.custom_mobs.abilities.tick.fireball.config.FireballThrowConfigBasic4;
import apple.voltskiya.custom_mobs.abilities.tick.fireball.config.FireballThrowConfigRapid;
