package apple.voltskiya.custom_mobs.abilities.tick.reviver;
...
import apple.voltskiya.custom_mobs.abilities.tick.reviver.config.ReviverConfigBasic;
import apple.voltskiya.custom_mobs.abilities.tick.reviver.config.ReviverConfigPulse;
