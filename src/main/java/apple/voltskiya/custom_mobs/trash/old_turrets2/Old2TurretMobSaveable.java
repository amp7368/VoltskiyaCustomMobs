...
public abstract class Old2TurretMobSaveable {
     ...
     */
    public Old2TurretMobSaveable() {
    }

    public Old2TurretMobSaveable(Old2TurretMob turretMob) {
    ...
    public abstract Old2TurretMob build();
