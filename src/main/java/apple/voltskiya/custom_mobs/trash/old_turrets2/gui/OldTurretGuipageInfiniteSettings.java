...
public class OldTurretGuipageInfiniteSettings extends InventoryGuiPageSimple {
    private final Old2TurretMobInfinite turretMob;

    public OldTurretGuipageInfiniteSettings(Old2TurretMobInfinite turretMob, InventoryHolder holder) {
        super(holder);
