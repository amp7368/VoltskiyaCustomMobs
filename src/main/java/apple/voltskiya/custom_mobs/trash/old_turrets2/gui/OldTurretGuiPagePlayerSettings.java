...
public class OldTurretGuiPagePlayerSettings extends InventoryGuiPageSimple {
    private final Old2TurretMobPlayer turretMob;

    public OldTurretGuiPagePlayerSettings(Old2TurretMobPlayer turretMob, InventoryHolder holder) {
        super(holder);
