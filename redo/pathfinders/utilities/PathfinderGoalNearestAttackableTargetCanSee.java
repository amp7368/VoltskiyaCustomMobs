...
public class NearestAttackableTargetGoalCanSee<T extends EntityLiving> extends NearestAttackableTargetGoal<T> {
    ...
    public NearestAttackableTargetGoalCanSee(Mob entityinsentient, Class<T> oclass, boolean flag) {
